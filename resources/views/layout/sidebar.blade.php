            ...
            <nav class='animated bounceInDown'>
                <ul>
                    <li class='sub-menu'><a href='#settings' class="btn-menu-avatar">Admin Bình Định<div
                        ...
                        <ul class="menu">
                            <li><a href='#settings'><i class="fas fa-user-tie"></i> Đổi ảnh đại diện</a></li>
                            <li><a href='#settings'><i class="fas fa-key"></i> Thay đổi mật khẩu</a></li>
                            <li><a href='#settings'><i class="fas fa-sign-out-alt"></i> Thoát</a></li>
                        </ul>
                    </li>
                    <li class='sub-menu'><a href='#message'><i class="fas fa-users"></i> Quản lý tài khoản
                        </a>
                    </li>
                    <li class='sub-menu'><a href='/decentralized'><i class="fas fa-user-circle"></i> Phân quyền tự đánh giá
                        </a>
                    </li>
